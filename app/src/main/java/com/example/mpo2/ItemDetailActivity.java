...
public class ItemDetailActivity extends Activity {
    ...
    private void initUI(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_layout_productdetail);
     ...
     * @param list
     */
    private void showList(List<ItemLot> list) {

        stockList = new ArrayList<Map<String, String>>();
        for (ItemLot productLot : list) {
            stockList.add(productLot.toMap());
        }

        SimpleAdapter sAdap = new SimpleAdapter(ItemDetailActivity.this, stockList,
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                if (quantityBox.getText().toString().equals("") || costBox.getText().toString().equals("")) {
                    ...
                    if (success) {
                        Toast.makeText(ItemDetailActivity.this, res.getString(R.string.success), Toast.LENGTH_SHORT).show();
                        costBox.setText("");
                        quantityBox.setText("");
                        onResume();
                        alert.dismiss();
                        ...
                        Toast.makeText(ItemDetailActivity.this, res.getString(R.string.fail) ,Toast.LENGTH_SHORT).show();
                    }
                }
